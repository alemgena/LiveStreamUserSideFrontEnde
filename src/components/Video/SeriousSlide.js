    ...
    <div>
      <Carousel className="carousel" interval={null}>
        <Carousel.Item className="item">
          ...
          <img src={`${img_300}${content1.poster_path}`} />
          <img src={`${img_300}${content2.poster_path}`} />
          <img src={`${img_300}${content3.poster_path}`} />
          <img src={`${img_300}${content4.poster_path}`} />
          <img src={`${img_300}${content5.poster_path}`} />
        </Carousel.Item>
        <Carousel.Item className="item">
          <img src={`${img_300}${content5.poster_path}`} />
          <img src={`${img_300}${content6.poster_path}`} />
          <img src={`${img_300}${content7.poster_path}`} />
          <img src={`${img_300}${content8.poster_path}`} />
          <img src={`${img_300}${content9.poster_path}`} />
          <img src={`${img_300}${content10.poster_path}`} />
        </Carousel.Item>
      </Carousel>
    </div>
  )
